...
const storeProduct = useProductStore2()
    ...
    <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
        <div class="row row-margin">
            <div class="col-md-3" v-for="(productData, index) in storeProduct.foodsList" :key="index">
                <div class="card">
                    <RouterLink :to="{ name: 'foodDetail', params: { id: productData.id }}">
                        <img :src="productData.img" class="card-img-top" alt="productimg">
                    </RouterLink>
                        <div class="card-body">
                        <RouterLink :to="{name: 'foodDetail', params: {id: productData.id}}" class="card-title">{{ productData.Name }}</RouterLink>
                        <div class="pricetag">
